...
diretorio_base = "C:\\Users\\Gustavo.Oliveira\\ETRNTY Capital Planejadora Financeira\\Investimentos - Documentos\\Performance mensal\\performance img\\fim"
...
for gestor in gestores_unicos:
    ...
    )]["RETORNO_COMPOSTO_ACUMULADO_PEER"].iloc[0]
    ...
    print("saving")
    fig.write_image(os.path.join(diretorio_base, f"{gestor} YTD.png"))
    print("saved")
    # fig.show()
