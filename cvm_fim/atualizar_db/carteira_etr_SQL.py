...
query_nm_fundo = 'SELECT CNPJ_FUNDO_COTA, NM_FUNDO_COTA FROM cvm_peers_fim'
df_nm_fundo = pd.read_sql(query_nm_fundo, con=engine)
mapping_dict = dict(
    zip(df_nm_fundo['CNPJ_FUNDO_COTA'], df_nm_fundo['NM_FUNDO_COTA']))


fund_name = "ETRNTY EON MM MASTER FIC FIM"
ETR_CNPJ = "47.716.356/0001-90"

# Busca todas as datas únicas da tabela
query_dates = 'SELECT DISTINCT DT_COMPTC FROM cvm_peers_fim_estimado'
...
# Salvando em SQL
final_df.to_sql('cvm_peers_fim_estimado', con=engine,
